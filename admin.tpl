{footer_script}
    ...
    function setSummary() {
        ...
        if ($selected === "0") {
            $summary = "You can copy, modify, distribute and perform the work, even for commercial purposes, all without asking permission.";
        } else if ($selected === "by") {
            ...
            $summary = "You are free to share (copy and redistribute the material in any medium or format) or adapt (remix, transform, and build upon the material) for any purpose, even commercially but must give appropriate credit and license new creations under the identical terms.";
